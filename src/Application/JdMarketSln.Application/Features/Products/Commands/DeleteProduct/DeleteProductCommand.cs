...
namespace JdMarketSln.Application.Features.Products.Commands.DeleteProduct
{
    ...
    public class DeleteProductCommandHandler : IRequestHandler<DeleteProductCommand, Response<DeleteProductDto>>
    {
        ...
        public DeleteProductCommandHandler(IProductGenericRepository productRepository, IMapper mapper)
        {
        ...
        public async Task<Response<DeleteProductDto>> Handle(DeleteProductCommand command, CancellationToken cancellationToken)
        {
            ...
            return new Response<DeleteProductDto>(_mapper.Map<DeleteProductDto>(response), "Product remove successful");
        }
    }
}
