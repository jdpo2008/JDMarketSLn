    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitMeasureProducts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockMin = table.Column<long>(type: "bigint", nullable: false),
                    StockMax = table.Column<long>(type: "bigint", nullable: false),
                    UnitMeasureProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductDetails_UnitMeasureProducts_UnitMeasureProductId",
                        column: x => x.UnitMeasureProductId,
                        principalTable: "UnitMeasureProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSubCategories_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductSubCategories_SubCategory_SubCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductDetails_UnitMeasureProductId",
                table: "ProductDetails",
                column: "UnitMeasureProductId");
